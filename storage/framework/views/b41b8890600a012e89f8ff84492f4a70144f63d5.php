...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="first_name" id="first_name" class="form-control" value="<?php echo e(old('first_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?php echo e(__('messages.Second_Name')); ?></label>
                            <input name="second_name" id="second_name" class="form-control" value="<?php echo e(old('second_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="last_name" id="last_name" class="form-control" value="<?php echo e(old('last_name')); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <option <?php if(old('category') == 3 && old('category') != ''): ?> selected="selected" <?php endif; ?> value="3"><?php echo e(__('messages.Exhibition')); ?></option>
                            </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laila\resources\views/admin/users/create.blade.php ENDPATH**/ ?>